...
#vep_df = pd.read_csv('/home/pelmo/data_and_pipelines/boar_taint_variant_analysis/scripts/ensembl-vep/picked_vep.csv', sep = "\t", comment = '%')
...
columns = ['IMPACT', 'STRAND', 'SYMBOL', 'SYMBOL_SOURCE', 'HGNC_ID', 'BIOTYPE', 'APPRIS', 'ENSP', 'SWISSPROT', 'TREMBL', 'UNIPARC', 'SIFT', 'DISTANCE', 'DOMAINS']
